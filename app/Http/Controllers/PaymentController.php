...
//     public function process(Request $request, $penyewa_id)
// {
//     $penyewa = Penyewa::findOrFail($penyewa_id);
//     // Logic to process the payment, e.g., store payment status, send receipt, etc.
    
//     // For now, we assume payment was successful
//     $penyewa->update(['payment_status' => 'paid']);

//     // Redirect back to Penyewa index or another page
//     return redirect()->route('backend.penyewa.index')->with('success', 'Pembayaran berhasil!');
// }
