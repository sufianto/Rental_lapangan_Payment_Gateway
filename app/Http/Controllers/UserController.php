...
class UserController extends Controller
{
    ...
    // {
    //     // Middleware role: 1 (Super Admin), 0 (Admin), 2 (Penyewa)
    //     $this->middleware('auth');
    //     $this->middleware('role:1')->only(['index', 'create', 'store', 'edit', 'update', 'destroy']);
    //     $this->middleware('role:0')->only(['index', 'edit', 'update', 'destroy']);
    ...
    public function cetakUser(Request $request)
{
    ...
    // Mengambil data user berdasarkan range tanggal
